...
const WEAPONS = [
  { id:1, icon:"⚔️", tag:"FOUNDATIONS", title:"The Reality of the Battle", subtitle:"You Are at War Whether You Know It or Not", color:"red",
    ...
    lexicon:[
      {word:"wrestle",original:"πάλη (palē)",language:"Greek",meaning:"Hand-to-hand combat; close-quarters wrestling.",note:"Paul deliberately chose palē rather than a word for ranged warfare. The Christian's struggle against spiritual forces is up-close — intimate, gripping, exhausting. The image is two opponents locked together, the outcome determined by leverage and endurance."},
      {word:"world rulers",original:"κοσμοκράτωρ (kosmokratōr)",language:"Greek",meaning:"World-ruler; cosmic-power; one who rules the present darkness.",note:"From kosmos (world) + krateō (to grasp, rule). Paul uses this term for the dark spiritual authorities operating in this age. They are not unlimited — Christ has all authority (Matt 28:18) — but they are real, organized, and require armor and engagement."}
    ],
  ...
  { id:2, icon:"🛡️", tag:"ARMOR", title:"The Full Armor of God", subtitle:"Dressed for Battle Every Single Day", color:"gold",
    ...
    lexicon:[
      {word:"full armor",original:"πανοπλία (panoplia)",language:"Greek",meaning:"Complete armor; the full equipment of a heavy infantryman.",note:"From pas (all) + hoplon (weapon/armor). Roman legionnaires wore panoplia — every piece needed, none optional. Paul commands believers to put on panoplia — not selected pieces. Partial armor leaves vulnerabilities the enemy will find."},
      {word:"stand",original:"ἵστημι (histēmi)",language:"Greek",meaning:"To stand firm; to hold position under attack.",note:"Paul uses histēmi four times in Ephesians 6:11-14. The Christian's posture in spiritual warfare is not advance but hold. The ground has already been taken by Christ. The believer's job is to stand on what is already won."}
    ],
  ...
  { id:3, icon:"🏰", tag:"FREEDOM", title:"Breaking Strongholds", subtitle:"Tearing Down What the Enemy Has Built", color:"red",
    ...
    lexicon:[
      {word:"stronghold",original:"ὀχύρωμα (ochurōma)",language:"Greek",meaning:"A fortress; a fortified position; a place taken and held.",note:"Originally a military term for a defensive structure built on high ground. Paul uses it for the mental/spiritual fortifications the enemy builds in our thinking — lies, patterns, false beliefs entrenched over time. They must be demolished, not negotiated with."},
      {word:"tear down",original:"καθαιρέω (kathaireō)",language:"Greek",meaning:"To demolish; to tear down completely.",note:"Kathaireō is what an army does to an enemy stronghold once captured — total destruction, no remnant. Paul's command is not to modify or contain the stronghold but to demolish it. Spiritual weapons exist for this destructive purpose."}
    ],
  ...
  { id:4, icon:"🔍", tag:"INTELLIGENCE", title:"Know Your Enemy", subtitle:"Understanding Satan's Character, Methods, and Limits", color:"steel",
    ...
    lexicon:[
      {word:"slanderer",original:"διάβολος (diabolos)",language:"Greek",meaning:"The slanderer; one who throws accusations across.",note:"From dia (across) + ballō (to throw). The devil's primary tactic is named in his title: throwing accusations across — at God about you, at you about yourself, at others about each other. Knowing his core method is half of resisting it."},
      {word:"scheme",original:"νόημα (noēma)",language:"Greek",meaning:"A device, plot, mental scheme; calculated thought-strategy.",note:"Paul says we are not ignorant of Satan's noēmata (2 Cor 2:11). The enemy operates through calculated mental strategies — not random attacks but engineered schemes. Discernment requires recognizing the strategy, not just the surface event."}
    ],
  ...
  { id:5, icon:"🔥", tag:"FASTING", title:"Fasting as a Weapon", subtitle:"The Discipline That Shifts the Spiritual Atmosphere", color:"red",
    ...
    lexicon:[
      {word:"fast",original:"צום (tsom)",language:"Hebrew",meaning:"To abstain from food for a religious purpose; to deny the appetite.",note:"Tsom is voluntary self-denial directed Godward. It is not weight management. It is the willing setting aside of legitimate needs to focus the soul. Isaiah 58 makes clear that God-honoring fasting also breaks bondages and feeds the hungry."},
      {word:"soul",original:"נפש (nephesh)",language:"Hebrew",meaning:"Soul; life; the full appetite-laden self.",note:"Nephesh is broader than \"soul\" in English. It includes hunger, thirst, desire — the appetitive self. When Scripture speaks of \"afflicting the soul\" (e.g., Isa 58:5), it means the deliberate setting aside of bodily appetite for spiritual purpose. Fasting affects the nephesh."}
    ],
  ...
  { id:6, icon:"📢", tag:"DECLARATIONS", title:"The Power of Declaration", subtitle:"What You Speak Has Spiritual Weight", color:"gold",
    ...
    lexicon:[
      {word:"overcome",original:"νικάω (nikaō)",language:"Greek",meaning:"To conquer; to be victorious; to prevail.",note:"The root of the name Nike. Revelation 12:11 says believers nikaō the accuser by the blood of the Lamb AND by the word of their testimony. Spoken testimony is part of the means of victory. Silence about what God has done leaves a weapon undeployed."},
      {word:"word/utterance",original:"ῥῆμα (rhēma)",language:"Greek",meaning:"A spoken word; an utterance issued at a specific moment.",note:"While logos describes the full body of God's message, rhēma is the specific spoken word for a specific moment. The sword of the Spirit (Eph 6:17) is the rhēma of God — the Scripture wielded as utterance in the moment of attack."}
    ],
  ...
  { id:7, icon:"🧠", tag:"MIND", title:"Warfare Over the Mind", subtitle:"The Battlefield Is Between Your Ears", color:"steel",
    ...
    lexicon:[
      {word:"thought",original:"νόημα (noēma)",language:"Greek",meaning:"A thought, mental product, scheme.",note:"The same word the enemy uses for his schemes (Weapon 4). Paul commands taking every noēma captive to Christ. The same battlefield — the mind — produces enemy attacks and Spirit-led obedience, depending on what is governing the thought-life."},
      {word:"take captive",original:"αἰχμαλωτίζω (aichmalōtizō)",language:"Greek",meaning:"To make captive; to lead prisoner under spear-point.",note:"Military vocabulary — taking prisoners of war. Paul does not say to ignore wrong thoughts or fight them politely. He says to capture them at spear-point and bring them into obedience to Christ. The mind is to be conquered, not merely managed."}
    ],
  ...
  { id:8, icon:"🦁", tag:"FEAR", title:"Fear — The Enemy's Most Used Weapon", subtitle:"Perfect Love Casts Out What the Enemy Most Deploys", color:"red",
    ...
    lexicon:[
      {word:"cowardice",original:"δειλία (deilia)",language:"Greek",meaning:"Cowardice; moral fearfulness; the spirit of timidity.",note:"Paul says God has NOT given believers this spirit (2 Tim 1:7). Deilia is more than normal apprehension — it is the moral failure of nerve. The opposite, in Paul's verse, is power, love, and a sound mind — not the absence of fear but the spirit that overcomes it."},
      {word:"perfect love",original:"τελεία ἀγάπη (teleia agapē)",language:"Greek",meaning:"Mature, complete love; love that has reached its full design.",note:"1 John 4:18 says teleia agapē casts out fear. The love is mature — not beginner love, but love that has been formed through trust. Fear is evicted by perfected love, the way light evicts darkness — not by force but by occupying the space."}
    ],
  ...
  { id:9, icon:"🎵", tag:"WORSHIP", title:"Warfare Through Worship", subtitle:"When Praise Becomes a Battle Strategy", color:"gold",
    ...
    lexicon:[
      {word:"praise",original:"הלל (halal)",language:"Hebrew",meaning:"To boast, celebrate, shine; to make a noise about someone's glory.",note:"The root of \"Hallelujah\" (Praise Yah). Halal is loud, public, celebratory praise — not quiet contemplation. In 2 Chronicles 20, Israel sent the halal-singers ahead of the army. The battle was won as praise went up."},
      {word:"song of praise",original:"תהלה (tehillah)",language:"Hebrew",meaning:"A song of praise; the act of celebrating someone's worth in music.",note:"From halal. Tehillah is the title of the book of Psalms in Hebrew (Tehillim). Psalm 22:3 says God is enthroned on the tehillah of His people — meaning praise prepares the throne where He sits and rules in the situation."}
    ],
  ...
  { id:10, icon:"🔗", tag:"FREEDOM", title:"Generational Strongholds", subtitle:"Breaking What Was Passed Down to You", color:"red",
    ...
    lexicon:[
      {word:"redeem",original:"ἐξαγοράζω (exagorazō)",language:"Greek",meaning:"To buy out of the marketplace; to redeem from bondage.",note:"From ek (out of) + agora (marketplace). Slaves were sold in the agora. Christ exagorazō-ed believers from the curse of the Law (Gal 3:13) — purchased them out of the slave market. Generational curses are broken at this transaction."},
      {word:"curse",original:"קללה (qelalah)",language:"Hebrew",meaning:"A curse; a pronouncement of judgment that binds across generations.",note:"In Hebrew thought, words spoken carried real spiritual weight that could perpetuate beyond the speaker's life. A qelalah was not metaphor. Christ became a curse (Gal 3:13) to absorb and cancel every qelalah that could pass to His people."}
    ],
  ...
  { id:11, icon:"⚡", tag:"DISCERNMENT", title:"Discerning the Enemy's Voice", subtitle:"Identifying Lies and Replacing Them With Truth", color:"steel",
    ...
    lexicon:[
      {word:"liar",original:"ψεύστης (pseustes)",language:"Greek",meaning:"A liar; one whose habitual speech is falsehood.",note:"Jesus calls the devil a pseustes and the father of lies (John 8:44). It is not that he lies sometimes — falsehood is his linguistic nature. The opposite, in John 10:27, is the Shepherd's voice — recognizable, true, calling each sheep by name."},
      {word:"father",original:"πατήρ (patēr)",language:"Greek",meaning:"Father; the source from which something originates.",note:"Patēr does not just mean biological father — it means the originating source. The devil is the patēr of lies because every lie has him as its source. Discerning the source of a thought (its patēr) is half of recognizing whether it is true."}
    ],
  ...
  { id:12, icon:"👑", tag:"AUTHORITY", title:"Walking in Spiritual Authority", subtitle:"Enforcing the Victory Jesus Already Won", color:"gold",
    ...
    lexicon:[
      {word:"authority",original:"ἐξουσία (exousia)",language:"Greek",meaning:"Legitimate delegated power; the right to act.",note:"Jesus gives believers exousia over all the power (dynamis) of the enemy (Luke 10:19). The distinction matters: the enemy has dynamis (raw force), but believers have exousia (legitimate jurisdiction). Authority outranks force when properly exercised."},
      {word:"submit",original:"ὑποτάσσω (hupotassō)",language:"Greek",meaning:"To arrange oneself under proper authority.",note:"James 4:7 commands believers to hupotassō to God FIRST, then resist the devil. The order matters. Authority over the enemy flows from submission to God. Trying to resist without first submitting yields none of the promised result."}
    ],
  ...
  { id:13, icon:"🙏", tag:"INTERCESSION", title:"The Weapon of Intercession", subtitle:"Praying Others Into Their Breakthrough", color:"gold",
    ...
    lexicon:[
      {word:"gap",original:"פרץ (peretz)",language:"Hebrew",meaning:"A breach, a gap in a wall, a broken-down place.",note:"In Ezekiel 22:30, God searches for someone to \"stand in the peretz\" — to step into the breach in the wall and intercede. The intercessor is the one who stands where the defenses have broken down. The peretz is dangerous, but it is where God looks for those willing."},
      {word:"intercede",original:"ἐντυγχάνω (entugchanō)",language:"Greek",meaning:"To meet with; to approach on behalf of another.",note:"Used of Christ at the Father's right hand interceding for believers (Rom 8:34). Entugchanō means to approach with a petition, to advocate. Christian intercession patterns on this — approaching God on someone else's behalf, the way Christ does for us."}
    ],
  ...
  { id:14, icon:"💎", tag:"PURITY", title:"Sexual Purity as Warfare", subtitle:"Closing the Door the Enemy Most Exploits", color:"red",
    ...
    lexicon:[
      {word:"sexual immorality",original:"πορνεία (porneia)",language:"Greek",meaning:"Sexual immorality; any sexual activity outside of God's covenant design.",note:"From which English \"pornography\" derives. Porneia is a broad term covering all sexual sin. Paul says it is unique among sins — \"every other sin a person commits is outside the body, but the sexually immoral person sins against their own body\" (1 Cor 6:18)."},
      {word:"flee",original:"φεύγω (pheugō)",language:"Greek",meaning:"To run away; to escape by flight.",note:"Paul does not say resist porneia. He says pheugō — flee, run, get away. Some battles are not won by standing ground but by leaving the field. Joseph fled from Potiphar's wife (Gen 39); David did not, and paid for decades. Pheugō is the right verb here."}
    ],
  ...
  { id:15, icon:"🌿", tag:"ENDURANCE", title:"Finishing the Fight", subtitle:"The Warfare of Not Quitting", color:"steel",
    ...
    lexicon:[
      {word:"finish",original:"τελέω (teleō)",language:"Greek",meaning:"To bring to completion; to finish what was begun.",note:"Paul's word in 2 Tim 4:7. Teleō is what Jesus said on the cross (tetelestai — \"it is finished\"). The Christian's call is not to win every battle but to teleō the race set before them. Finishing is the standard of faithfulness."},
      {word:"endure",original:"ὑπομονή (hupomonē)",language:"Greek",meaning:"Patient endurance; remaining under pressure.",note:"The same word central to AS1 Week 7. Hebrews 12:1 commands running the race with hupomonē. Endurance is not a personality trait but a discipline — staying under pressure long enough for the testing to do its work."}
    ],
  ...
  { id:16, icon:"✝️", tag:"THRONE NAME", title:"The Name of Jesus", subtitle:"Authority Above All Authority", color:"crimson",
    ...
    lexicon:[
      {word:"name",original:"ὄνομα (onoma)",language:"Greek",meaning:"A name; in biblical thought, the bearer of authority and identity.",note:"Names in Scripture carry the weight of the person named. To act \"in the name of Jesus\" is to act with His delegated authority. Philippians 2:9 says God exalted Him and gave Him the onoma above every name — meaning no authority can outrank His."},
      {word:"Lord",original:"κύριος (kyrios)",language:"Greek",meaning:"Lord; master; the one with rightful authority.",note:"Kyrios was the Greek translation for YHWH in the Septuagint. When Phil 2:11 says every tongue will confess Jesus is kyrios, Paul is making a divine claim — the same word reserved for God Himself is rightly applied to Jesus. There is no higher Lord."}
    ],
  ...
  { id:17, icon:"🩸", tag:"COVENANT BLOOD", title:"The Blood of Jesus", subtitle:"The Silencer of Every Accusation", color:"crimson",
    ...
    lexicon:[
      {word:"blood",original:"αἷμα (haima)",language:"Greek",meaning:"Blood; in biblical thought, the life of a person.",note:"Leviticus 17:11 says \"the life of the flesh is in the blood.\" Christ's haima is not just the death — it is the offered life, the only acceptable payment for sin. Revelation 12:11 names the haima as the first means of overcoming the accuser."},
      {word:"accuser",original:"κατήγωρ (katēgōr)",language:"Greek",meaning:"Accuser; the legal title for one who lays charges in court.",note:"The devil's role in Revelation 12 is katēgōr — bringing charges against believers day and night before God. The blood of Christ silences these accusations because the price they would demand has already been paid. Accusations against the redeemed have no legal standing."}
    ],
  ...
  { id:18, icon:"🎺", tag:"BATTLE PRAISE", title:"Praise as a Weapon", subtitle:"God Inhabits the Praises of His People", color:"gold",
    ...
    lexicon:[
      {word:"praise",original:"הלל (halal)",language:"Hebrew",meaning:"To boast loudly; to celebrate publicly.",note:"The root of \"Hallelujah.\" In 2 Chr 20:22, Israel sang halal-praises and \"the LORD set ambushes\" against their enemies. The praise was the deployment of the weapon. The battle was not won by the soldiers but by the singers."},
      {word:"inhabit",original:"ישב (yashav)",language:"Hebrew",meaning:"To sit, dwell, be enthroned.",note:"Psalm 22:3 (KJV) says God yashav-s the praises of His people — He sits enthroned on their praise. The image: praise builds the throne where God exercises rule in your situation. Where praise is, His ruling presence is."}
    ],
  ...
  { id:19, icon:"🕊️", tag:"BREAKING CHAINS", title:"The Weapon of Forgiveness", subtitle:"Closing the Door Offense Opens", color:"steel",
    ...
    lexicon:[
      {word:"send away",original:"ἀφίημι (aphiēmi)",language:"Greek",meaning:"To release, let go, dismiss a debt.",note:"The standard New Testament verb for forgiveness (also AS1 W11). Aphiēmi releases the offender from what they owe — not because they earned it, but because the receiver chooses to absorb the cost. The decision precedes the feeling."},
      {word:"place/foothold",original:"τόπος (topos)",language:"Greek",meaning:"A place, position, opportunity.",note:"Ephesians 4:27 commands \"do not give the devil topos.\" Unforgiveness, anger held overnight, harbored offense — all give the enemy real estate inside your life. Topos is occupied territory. Forgiveness is the eviction."}
    ],
  ...
  { id:20, icon:"🔗", tag:"CORPORATE POWER", title:"Unity and Agreement", subtitle:"Where Two or Three Agree, Heaven Moves", color:"steel",
    ...
    lexicon:[
      {word:"agree",original:"συμφωνέω (symphōneō)",language:"Greek",meaning:"To agree, sound together as in music.",note:"The root of English \"symphony.\" When two believers symphōneō in prayer (Matt 18:19), they are not just agreeing on a point — they are sounding together, harmonizing. The agreement is musical, structural. Where this happens, Christ promises to be present and to act."},
      {word:"gathered",original:"συνάγω (synagō)",language:"Greek",meaning:"To gather together, assemble.",note:"From syn (together) + agō (to bring). Jesus says where two or three are synagō-ed in His name, He is there (Matt 18:20). The same root as synagogue. The gathering itself, when in His name, becomes the place He inhabits."}
    ],
  ...
  { id:21, icon:"🗣️", tag:"WORDS OF POWER", title:"The Power of the Tongue", subtitle:"Life and Death Are in Your Words", color:"crimson",
    ...
    lexicon:[
      {word:"tongue",original:"לשון (lashon)",language:"Hebrew",meaning:"Tongue; by extension, speech, language, what is spoken.",note:"Proverbs 18:21 says life and death are in the power of the lashon. The Hebrew uses tongue as metonym for speech. Words are not neutral. They carry power to give life or to inflict death — including on the speaker themselves."},
      {word:"word",original:"דבר (davar)",language:"Hebrew",meaning:"A word; a thing; what is spoken into existence.",note:"In Hebrew, davar means both \"word\" and \"thing\" — because spoken words were understood to create reality. God created the cosmos by davar. When humans speak, they are using the same instrument God used in Genesis 1. Words make worlds."}
    ],
  ...
  { id:22, icon:"🙇", tag:"LOWLY STRENGTH", title:"The Weapon of Humility", subtitle:"God Opposes the Proud, Arms the Humble", color:"steel",
    ...
    lexicon:[
      {word:"humble",original:"ταπεινόω (tapeinoō)",language:"Greek",meaning:"To lower, to humble; to bring or be brought low.",note:"The verb form of tapeinophrosynē (AS1 W10). James 4:6 quotes Prov 3:34 — God gives grace to the tapeinos. Humility is not weakness; it is the deliberate self-lowering that positions one to receive grace. Pride blocks the very thing the humble person can receive."},
      {word:"resist",original:"ἀντιτάσσομαι (antitassomai)",language:"Greek",meaning:"To arrange against; to draw up battle lines against.",note:"Military vocabulary — formation taken to oppose an army. James 4:6-7 says God antitassomai the proud — He draws battle lines against them. The same verb appears twice: God resists the proud; believers resist the devil. Position determines which side of the line you stand on."}
    ],
  ...
  { id:23, icon:"🕊️", tag:"WARFARE THROUGH REST", title:"The Weapon of Rest", subtitle:"In Quietness and Trust Is Your Strength", color:"steel",
    ...
    lexicon:[
      {word:"returning",original:"שובה (shuvah)",language:"Hebrew",meaning:"A turning back, a returning to where one belongs.",note:"From shuv (AS1 W5). Isaiah 30:15 says \"in returning and rest you shall be saved.\" Rest is not first about cessation of activity — it is about returning to right position under God. Many cannot rest because they have not yet returned."},
      {word:"be still",original:"רפה (raphah)",language:"Hebrew",meaning:"To let go, drop the hands, cease striving.",note:"The verb behind \"Be still and know that I am God\" (Ps 46:10). Raphah literally means to relax one's grip — to let go. The command is not \"be quiet\" but \"stop trying to control.\" Rest is the consequence of letting God be God in the situation."}
    ],
...
function MemorizeModal({verse, onClose, get, set, C}) {
            ...
            {(weapon.lexicon || []).map((entry, i) => (
              <div key={i} style={{background:C.bgCard,border:`1px solid ${C.borderGold}`,borderRadius:16,padding:"22px 24px 20px",marginBottom:14}}>
                ...
                <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:2}}>
                  ...
                  <button onClick={() => speak(entry)} aria-label="Hear pronunciation" style={{background:speaking?"rgba(176,138,78,0.35)":"rgba(176,138,78,0.12)",border:`1px solid ${C.borderGold}`,color:C.gold,width:32,height:32,borderRadius:"50%",cursor:"pointer",fontSize:14,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,padding:0,touchAction:"manipulation"}}>{speaking?"▶":"🔊"}</button>
                </div>
